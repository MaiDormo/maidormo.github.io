    ...
    <div className="min-h-screen bg-black text-zinc-400 p-6 md:p-12 lg:p-24 selection:bg-zinc-800 selection:text-white">
      <div className="max-w-4xl mx-auto">
        <header className="mb-20 animate-fade-in-up">
          <span className="font-mono text-zinc-500 text-sm mb-3 block">
            elia@local:~$ ./whoami
          </span>
          ...
          <p className="text-xl md:text-2xl text-zinc-300 font-medium mb-6">
            Software Engineer <span className="text-zinc-600">|</span> HPC &
            Distributed Systems
          </p>
          ...
          <div className="flex flex-col gap-16">
            {externalProjects.map((project: Project, idx: number) => (
              <div key={idx} className="group flex flex-col md:flex-row gap-8">
                ...
                <div
                  className={`flex flex-col justify-center ${project.imageUrl ? 'md:w-3/5' : 'w-full'}`}
                >
                  ...
                  {project.decision && (
                    <div className="mb-4">
                      <strong className="text-zinc-300 text-sm block mb-1">
              ...
              {(experiences ?? []).map((exp: Experience, idx: number) => (
                <div key={idx}>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-zinc-400 hover:text-white block mb-2 text-sm"
                  >
                    {exp.company}
                  </a>
